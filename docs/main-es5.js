    ...
    function () {
      ...
      _createClass(BookingComponent, [{
        ...
        value: function sendEmail(e) {
          e.preventDefault();
          emailjs_com__WEBPACK_IMPORTED_MODULE_2___default.a.sendForm('contact_service', 'template_hixVfBEB', e.target, 'user_XK5jxSG3P3tlkv4kRdji2').then(function (result) {
